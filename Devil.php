...
<div id="demo" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="images/devil1.jpg" alt="Cha town" width="1000" height="500">
...
<section class="my-5">
    <div class="py-5">
        <h2 class="text-center"> Озеро Шайтанколь </h2>
    </div>
    <div>
        <div class="row">
            <div class="col-lg-6 col-md-6 col-12">
                <img src="images/char3.jpg" class="img-fluid" aboutimg>
            </div>
            <div class="col-lg-6 col-md-6 col-12">
                <h2 class="display-4">Захватывающее дух место</h2>
                <p class="py-3">Одно из самых таинственных озер Казахстана находится рядом с городом Каркаралинск в Карагандинской области и создано матушкой-природой. Озеро Шайтанколь, что в переводе с казахского означает "Чертово озеро", наводит страх на местных жителей
                    До сих пор, как бы ни старались ученые, глубина горного водоема не установлена. Эзотерики твердят о портале в параллельный мир через его двойное дно. Народные предания гласят о шабашах чертей, танцах русалок и призраках двух влюбленных. Но известно одно и точно: кто побывал однажды у его берегов, никогда не забудет это место…</p>
            </div>
        </div>
    </div>
</section>
