...
<section class="my-5">
    <div class="py-5">
        <h2 class="text-center"> Ye's Tourism </h2>
    </div>
    <div>
        <div class="row">
            <div class="col-lg-6 col-md-6 col-12">
                <img src="images/tour.jpg" class="img-fluid" aboutimg>
            </div>
            <div class="col-lg-6 col-md-6 col-12">
                <h2 class="display-4">Казахстан может удивить</h2>
                <p class="py-3">Наша задача состоит в том чтобы развивать туристическую сторону нашей страны. Данная работа была начата для продвижения туризма в нашей стране. Ведь по стереотипам туристическими странами могут считаться страны Европы и ближнего востока. И кстати, это касается не только зарубежных туристов, но и наших соотечественников. И связи с последними событиями в политическом мире, заинтересованность в открытии для себя природы и достопримечательностей нашей страны, возможен наплыв туристов из ближайших к нам стран. И моей задачей стало разработать веб сайт для удобства выбора и поиска информации о местах для туризма. </p>
            </div>
        </div>
    </div>
</section>
